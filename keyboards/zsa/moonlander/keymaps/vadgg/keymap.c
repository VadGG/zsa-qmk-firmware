...
// ------------- COMBO ---------------
const uint16_t PROGMEM custom_esc[] = {KC_S, KC_D, COMBO_END};
const uint16_t PROGMEM custom_enter[] = {KC_K, KC_J, COMBO_END};
const uint16_t PROGMEM custom_colon[] = {KC_J, KC_H, COMBO_END};
const uint16_t PROGMEM custom_backspace[] = {KC_0, KC_EQUAL, COMBO_END};
const uint16_t PROGMEM custom_backspace_word[] = {KC_9, KC_0, KC_EQUAL, COMBO_END};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT(
     ...
     //|-----------------------------------------------------------------------------------------------------------|--------------------------|--------------------------|--------------------------|--------------------------|--------------------------|--------------------------|-----------------------------------------------------------------------------------------------------------|
                                                                                                                    KC_SPC,                    MO(NUM),                   _______,                  TD(MY_CMOD),                MO(NAV),                   KC_LSFT
     //|-----------------------------------------------------------------------------------------------------------|--------------------------|--------------------------|--------------------------|--------------------------|--------------------------|--------------------------|-----------------------------------------------------------------------------------------------------------|
    ),
